...
class Print extends Component {
  ...
  GetItem(nama_resep, cara_buat) {
    Alert.alert(nama_resep, cara_buat);
    }
    ...
    componentDidMount() {
      ...
      return fetch('https://iwes.000webhostapp.com/Z_1515051052/viewresepmakanan.php')
        ...
        <View style={styles.MainContainer}>
          ...
          <ListView
            ...
            renderRow={(rowData) => <View style={styles.rowViewContainer} >
                      ...
                      <TouchableOpacity onPress={this.GetItem.bind(this, rowData.bahan, rowData.cara_buat)} >
